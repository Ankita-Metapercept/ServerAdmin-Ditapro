        ...
        <div class="table-responsive mt-4">
          <table class="table table-hover mb-0 table-centered table-nowrap">
            <tbody>
              <tr>
                <td>
                  <h5 class="font-size-14 mb-0">Project 1</h5>
                </td>
              </tr>
              <tr>
                <td>
                  <h5 class="font-size-14 mb-0">Project 2</h5>
                </td>
              </tr>
              <tr>
                <td>
                  <h5 class="font-size-14 mb-0">Project 3</h5>
                </td>
              </tr>
              <tr>
                <td>
                  <h5 class="font-size-14 mb-0">Project 4</h5>
                </td>
              </tr>
            </tbody>
          </table>
